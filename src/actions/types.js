...
export const ADD_MODE_RESPONSE = "ADD_MODE_RESPONSE";
export const EDIT_MODE_RESPONSE = "EDIT_MODE_RESPONSE";
...
export const ADD_MODE_SKILL = "ADD_MODE_SKILL";
export const EDIT_MODE_SKILL = "EDIT_MODE_SKILL";
